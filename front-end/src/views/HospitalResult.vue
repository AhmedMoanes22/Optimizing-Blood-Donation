...
<Header />
    ...
    <main class="px-4 py-6 max-w-md mx-auto">
      <h1 class="text-2xl font-bold text-gray-900 mb-6 text-center">
        The nearest hospital to your address is
      </h1>
    ...
    <!-- Footer -->
    <footer class="bg-gradient-to-r from-red-600 to-red-800 text-white px-4 py-6 mt-auto">
...
const hospital = ref({
  name: 'Saint Maria Hospital',
  address: '21 Al-Hakmdar, East Health, Assiut Center, Assiut Governorate 2090377',
  image: 'https://images.unsplash.com/photo-1551190822-a9333d879b1f?w=120&h=80&fit=crop&crop=center'
})


const continueToHospital = () => {
  // Handle continue action
  console.log('Continuing to hospital:', hospital.value.name)
